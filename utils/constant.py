...
# LABEL_GROUPS=[
#     [14,16,17,18,20,22],[1],[2,19],[3]]

INFINITY_NUMBER = 1e12

REL_ENTITIES=[['ORGANIZATION', 'PERSON'], ['PERSON', 'PERSON'], ['ORGANIZATION', 'ORGANIZATION'], ['ORGANIZATION', 'NUMBER'], ['ORGANIZATION', 'DATE'], ['PERSON', 'ORGANIZATION'], ['PERSON', 'NATIONALITY'], ['PERSON', 'LOCATION'], ['PERSON', 'TITLE'], ['PERSON', 'DATE'], ['PERSON', 'CITY'], ['ORGANIZATION', 'MISC'], ['PERSON', 'COUNTRY'], ['PERSON', 'MISC'], ['PERSON', 'CRIMINAL_CHARGE'], ['ORGANIZATION', 'CITY'], ['ORGANIZATION', 'LOCATION'], ['PERSON', 'RELIGION'], ['PERSON', 'NUMBER'], ['PERSON', 'DURATION'], ['ORGANIZATION', 'RELIGION'], ['ORGANIZATION', 'URL'], ['PERSON', 'STATE_OR_PROVINCE'], ['ORGANIZATION', 'COUNTRY'], ['ORGANIZATION', 'STATE_OR_PROVINCE'], ['ORGANIZATION', 'IDEOLOGY'], ['PERSON', 'CAUSE_OF_DEATH']]

MAX_DIS=10

no_pass=[7,10,11,9,27,36,38,41]
ENTITY_POS=[]
appos=16
